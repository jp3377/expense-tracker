...
const App = () => {
  ...
  //to save the token and user data in localStorage or sessionStorage based on remember me option
    ...
    (async () => {
      try {
        ...
        try {
          ...
          console.error("Error loading transactions from storage:", storageErr);
        }
      }
    })();
  }, []);
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute user={user}>
          ...
          <Route path='/profile' element={<Profile user={user}
            onUpdateProfile={updateUser} onLogout={handleLogin} />
          }
          />
        </Route>
