                ...
                <form onSubmit={(e) => {
                    ...
                    <div className={modalStyles.form}>
                        ...
                        <div>
                            ...
                            <select value={newTransaction.category} onChange={(e) => setNewTransaction((prev) => ({ ...prev, category: e.target.value }))} className={modalStyles.input(colorClass.ring)} required>
                                {categories.map((cat) => (
                        ...
                        <div>
                            ...
                            <input type="date" value={newTransaction.date} min={minDate} max={currentDate}
