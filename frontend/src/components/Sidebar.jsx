...
const Sidebar = ({ user, isCollapsed, setIsCollapsed }) => {
    ...
    // to close sidebar when clicked outside in mobile
    useEffect(() => {
    ...
    // a small component for rendering menu items
            ...
            >
                <div className={sidebarStyles.sidebarInner.base}>
                    ...
                    <div className={cn(
                        ...
                        )} to="https://jp-dev--portfolio.vercel.app/" target='_blank'>
                        ...
                        >
                            <div className=" relative h-full flex flex-col">
                                ...
                                <div className={sidebarStyles.mobileFooter}>
                                    <Link className={sidebarStyles.mobileFooterLink} to="https://jp-dev--portfolio.vercel.app/" target='_blank'>
                                        <HelpCircle size={20} className=" text-gray-500" />
                                        <span>Support</span>
                                    </Link>
