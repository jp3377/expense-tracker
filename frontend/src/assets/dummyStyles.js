...
export const dashboardStyles = {
  ...
  pieChartContainer: "hidden md:block bg-white lg:-mx- md:-mx-4 lg:p-1 xl:-mx-3 rounded-xl p-5 shadow-sm border border-gray-100 relative overflow-hidden mb-8",
  ...
  // pieChartContainer: "hidden md:block bg-white lg:-mx-5.5 md:-mx-4 lg:p-1 xl:-mx-3 rounded-xl p-5 shadow-sm border border-gray-100 relative overflow-hidden mb-8 min-w-0",
  // pieChartHeight: "w-full h-[400px] xl:h-[350px]",
