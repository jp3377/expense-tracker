...
import { GAUGE_COLORS, COLORS, INCOME_COLORS, EXPENSE_CATEGORY_ICONS, INCOME_CATEGORY_ICONS } from '../assets/color'
import { useOutletContext } from 'react-router-dom';
import { getTimeFrameRange, getPreviousTimeFrameRange, calculateData } from '../components/Helper';
import axios from 'axios';
import { ArrowDown, BarChart2, ChevronDown, ChevronUp, DollarSign, TrendingUp as ProfitIcon, PieChart as PieChartIcon, PiggyBank, Plus, ShoppingCart, TrendingDown, TrendingUp, Wallet } from 'lucide-react';
...
//to convert date to ISO format for backend
          ...
          additionalContent={
            <div className=" mt-2 text-xs text-cyan-600  flex items-center gap-2">
              ...
              {typeof overviewMeta.savingsRate === "number" && (
                <span className={`px-2 py-1 round-full text-xs font-medium ${overviewMeta.savingsRate < 0
