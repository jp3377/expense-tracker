...
const Profile = ({ onUpdateProfile, onLogout }) => {
    ...
    const handleSaveProfile = async () => {
        try {
            ...
            if (data) {
                ...
                toast.success("Ptofile updated successfully!");
            }
        } catch (err) {
    ...
    const handlePasswordSubmit = async (e) => {
        ...
        try {
            ...
            toast.success("Passwprd changed successfully!");
            ...
            <div className={profileStyles.mainContainer}>
                ...
                <div className={profileStyles.content}>
                    <div className={profileStyles.grid}>
                            ...
                            {editMode ? (
                                <div className=" space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="emial" name="email" value={tempUser.email}
                                            onChange={handleInputChange} className={profileStyles.input}
                                            disabled={loading} />
                                    </div>
                        ...
                        mt-6 w-full hover:opacity-90 transition-opacity`} disabled={loading}>
